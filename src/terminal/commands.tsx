...
const commands = {
    ...
    "contact": (
        <div className='command-output'>
            You can reach me on <a href="https://www.linkedin.com/in/beatrizfoliveira/" target="_blank">Linkein</a> or by <a href="mailto:foliveira.beatriz@gmail.com" target="_blank">email</a>.
        </div>
    ),
    "kissme": (
        <div className='command-output'>
